...
class Login extends CI_Controller{
	...
	public function index(){
		...
		$this->form_validation->set_message('required', 'U bent vergeten {field} in te vullen.');
		...
		*/
		...
		if($this->form_validation->run()==TRUE){ // als er een correcte validatie heeft plaatsgevonden.
			...
			$this->load->model('login_model','login');	//voor controle of in te loggen mogelijk is.
